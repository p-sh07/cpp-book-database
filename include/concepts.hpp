...
template <typename P /*,typename BookType*/>  //-> adding this makes BookPredicate require to specify explicit template
                                              //parameters in code
                                              concept BookPredicate =
                                                  /*IsBook<BookType> && */ requires(P pred, const Book &book_type) {
                                                      // Accepts a book type
