...
//TODO: не до конца понятно, в чем смысл использования в этих функциях flat_ контейнеров, более эффективный поиск по результатам?
...
double calculateAverageRating(const BookDatabase<T>& db) {
    ...
    //more eficient? https://stackoverflow.com/questions/76796910/why-do-we-have-stdtransform-reduce-in-c-standard-library
